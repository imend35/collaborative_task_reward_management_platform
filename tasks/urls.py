...
urlpatterns = [
    ...
    path("workspaces/<int:pk>/rewards/", workspace_reward_list, name="workspace-reward-list"),
    path("workspaces/<int:pk>/rewards/create/", reward_create, name="reward-create"),
    path("workspaces/<int:pk>/rewards/<int:reward_id>/edit/", reward_edit, name="reward-edit"),
    path("workspaces/<int:pk>/rewards/<int:reward_id>/toggle/", reward_toggle, name="reward-toggle"),
    path(
